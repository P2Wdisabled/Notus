...
async function migrateTermsAcceptance() {
  try {
    console.log(
      "🔄 Migration des utilisateurs existants - Acceptation des conditions d'utilisation...\n"
    );
    ...
    if (tableInfo.rows.length === 0) {
      console.log(
        "   ❌ Colonne 'terms_accepted_at' non trouvée. Exécutez d'abord l'initialisation de la base de données."
      );
      return;
    }

    console.log("   ✅ Colonne 'terms_accepted_at' trouvée");
    ...
    console.log(
      "   ⚠️  Cette opération va ajouter une date d'acceptation fictive"
    );
    console.log(
      "   ⚠️  pour tous les utilisateurs existants sans date d'acceptation."
    );
    console.log("   ⚠️  La date sera fixée à la date de création du compte.");
    ...
    console.log("\n6. Exemples d'utilisateurs migrés:");
    ...
    console.log("\n📋 Résumé:");
    console.log(
      "1. ✅ Colonne 'terms_accepted_at' ajoutée à la base de données"
    );
    console.log(
