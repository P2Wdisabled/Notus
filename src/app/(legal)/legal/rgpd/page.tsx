      ...
      <div className="max-w-4xl mx-auto px-4">
        <Card>
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <p>
              <strong>Prestations et Services :</strong> https://notus.fr met à
            ...
            <ul>
              <li>
                <strong>Propriétaire :</strong> SARL Notus Capital social de
                5000€ Numéro de TVA: FR02921419131 – 12 allée andré maurois
                87000 Limoges
              </li>
              <li>
                <strong>Responsable publication :</strong> Lajudie –
                francoispierre.lajudie@etu.unilim.fr
              </li>
              <li>
                <strong>Webmaster :</strong> POTEVIN – 763883580
              </li>
              <li>
                <strong>Hébergeur :</strong> OVH – 2, rue Kellermann 59100
                Roubaix
                https://help.ovhcloud.com/csm?id=contact_us_ovh&_gl=1*1vxqtla*_gcl_au*NzQ5MTIwMjM4LjE3NTU3MDE2NzA.
              </li>
              <li>
                <strong>Délégué à la protection des données :</strong>{" "}
                LegalPlace – contact@LegalPlace.fr
              </li>
            </ul>
